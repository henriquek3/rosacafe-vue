<template>
    <header class="app-header">
        <router-link class="app-header__logo" to="/dashboard">Rosa Café</router-link>
        ...
        <ul class="app-nav">
            ...
            <!-- User Menu-->
            <li class="dropdown"><a aria-label="Open Profile Menu" class="app-nav__item" data-toggle="dropdown"
                                    href="#"><i
